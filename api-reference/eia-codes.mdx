...
This API uses standardized codes from the U.S. Energy Information Administration (EIA) to represent balancing authorities, energy sources, and prime movers.
